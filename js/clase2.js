...
/*
1) Crea una variable con el nombre mostrarMensaje y dale un valor true o false. Evalúe con una sentencia condicional su
expresión lógica. Si es true, genere una mensaje en consola con la siguiente frase: "Bienvenido a mi web",
en caso contrario, muestre en consola: "Usted no tiene acceso".
*/
...
if (mostrarMensaje === true){
    ...
    console.log("Usted no tiene acceso")
}
*/

/*
2) Crear una estructura condicional que evalúe si un número, alojado en una variable, es positivo. En el caso de que
así sea, envíe un mensaje en consola con la siguiente frase: "Este número vibra alto", en el caso de que el número sea
negativo, envie un mensaje en consola: "Este número es negativo".
*/
...
/*
let semaforoColor = prompt( "Ingrese el color de semaforo" );

if ( semaforoColor === "Rojo" || semaforoColor === "rojo" || semaforoColor === "Amarillo" || semaforoColor === "amarillo" ){
    console.log( "false" );
} else if ( semaforoColor === "Verde" ){
    console.log( "true" );
} else {
...
/*
const stringUsuario = prompt( "Ingrese un caracter" );

if ( stringUsuario === "a" || stringUsuario === "e" || stringUsuario === "i" || stringUsuario === "o" || stringUsuario === "u" || stringUsuario === "A" || stringUsuario === "E" || stringUsuario === "I" || stringUsuario === "O" || stringUsuario === "U" ){
