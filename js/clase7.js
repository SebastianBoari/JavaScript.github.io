...
function crearCuentaRegresiva( numeroInicial ){
    ...
    while (numeroInicial > 0){
        cuentaRegresiva.push(numeroInicial);
        numeroInicial--;
    }
...
console.log(crearCuentaRegresiva(21));
...
// RESUELTO
 const invertir = [5, 7, 99, 34, 54, 2, 12]; // [12, 2, 54, 34, 99, 7, 5]

function invertirArray( arrayAInverir ){
   return arrayAInverir.reverse();
}

console.log(invertirArray(invertir));
